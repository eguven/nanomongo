...
**Version 0.4**: Utility methods `dbref_field_getters`_, `BaseDocument.get_dbref <http://nanomongo.readthedocs.org/en/latest/document.html#nanomongo.document.BaseDocument.get_dbref>`_
